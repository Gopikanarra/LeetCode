...
<br>
<center>
<div style="box-shadow: 1px 1px 1px 1px;width: 400px;height: 200px;padding: 20px">

	<form method="post" action="facultypage.jsp">
	<table>
		<tr>
		<td>HOD Id:</td>
        ...
        try {
            ...
            if (request.getParameter("login") != null) {
                ...
                try {
                    ...
                    out.println("Invalid faculty ID format. Please enter a valid integer.");
                    return; // Exit the JSP processing
                }
                String user_pwd = request.getParameter("pwd");

                // SQL query to check faculty credentials
                String query = "SELECT * FROM faculty_login_table WHERE fac_id = ? AND pwd = ?";
